...
String apiKey = "DCU";
//const char* logServer = "117.218.35.237";
const char* logServer = "103.208.152.191";
String data;
...
{
int i,  num =1; 
char *TCP_CONN_ESTABLISED[1] = {"AT+QIOPEN=1,0,\"TCP\",\"103.208.152.191\",587,0,1"} ;//103.208.152.191//117.218.35.237
for (i = 0; i < num; i++) 
{
